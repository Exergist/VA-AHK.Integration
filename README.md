...
I probably will not keep up with all the releases of AutoHotkey going forward. However if new VA-AHK.Integration releases are available the *.vax* import process will update your existing files. 
