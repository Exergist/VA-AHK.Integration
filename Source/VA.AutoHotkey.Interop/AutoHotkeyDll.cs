...
namespace VA.AutoHotkey.Interop
{
    ...
    /// executable.
    /// </summary>
    public class AutoHotkeyDll //^^MODIFY. changed to "public" class
    {
        public const string DLLPATH = "AutoHotkey.dll";

        #region Create Thread

        /// <summary>
        /// Start new thread from ahk script file. Existing threads are terminated. 
        /// </summary>
        ...
        /// <summary>
        /// Start a new thread from ahk text/variable. Existing threads are terminated. 
        /// </summary>
        ...
        /// <summary>
        /// Reload thread using same parameters used with ahkdll or ahktextdll.ahk
        /// </summary>
        [DllImport(DLLPATH, CharSet = CharSet.Unicode, CallingConvention = CallingConvention.Cdecl)]
        public static extern void ahkReload(uint timeout); //^^MODIFY. Introduce variable timeout
        ...
        /// </summary>
        /// <param name="code">script that will be added to a running script.</param>
